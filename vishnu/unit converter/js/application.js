...
//different properties and different units
...
factor[12] = new Array(1, 1000, 1000000, .001, .2930667, 1054.35, 17.5725, .2928751, 4.184, 6.973333E-02, .0000001, .0003766161, .02259697, 1.355818, 745.7, 746, 
	9809.5, 735.499, 745.7, 69.7333, 4184);
...
factor[17] = new Array(1, .000001, .000000001, 1233.482, .1589873, .002359737, .03523907, .0002365882, .00002957353, .02831685, .004546087, .004404884, .003785412, .0001420652, .0001182941, .00001638706, .001, .001000028, .00002841305, .00002957353, 8.8097680E-03, .0005506105, 4.7317650E-04, .001101221, 9.46353E-04, 1, .00001478676, .000004928922, 2.831685, .7645549);
...
if (document.property_form.the_menu.selectedIndex == 0){
	if (document.images){
		...
		// give him/her a clue...
		alert("The browser you are using won't let you run JSUC correctly. Maybe you should upgrade...");
	}
}
